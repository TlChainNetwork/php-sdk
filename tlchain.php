...
class Ethereum extends JSON_RPC
{
	...
	{
		if(!is_a($transaction, 'TLChain_Transaction'))
		{
	...
	{
		if(!is_a($message, 'TLChain_Message'))
		{
...
/**
 *	TLChain message -- Same as a transaction, except using this won't
...
/**
 *	TLChain transaction filter object
 */
